...
class Patient:
  ...
  def __lt__(self, patient):
    return self._outcome < patient.get_outcome()
  ...
  def compute_distance(self, patient, *features):
    ...
    for feature in features:
      ...
      features_1.append(self.get_feature(feature))
      features_2.append(patient.get_feature(feature))

    list_of_features_1 = features_1 or self.get_features()
    list_of_features_2 = features_2 or patient.get_features()
